        ...
        <div x-show.transition.opacity.duration.400ms="isOpen"
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button wire:click="{{ $wireClick }}" x-ref="confirmButton" type="button"
                        ...
                        py-2 bg-blue text-base font-medium text-white hover:bg-blue-hover focus:outline-none
                        focus:ring-2 focus:ring-offset-2 focus:ring-blue sm:ml-3 sm:w-auto sm:text-sm">
                    {{ $modalAction }}
                </button>
