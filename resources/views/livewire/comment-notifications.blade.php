<div x-data="{ isOpen: false }" class="relative">
    ...
    ">
        <svg class="h-8 w-8 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
            <path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10
            18a3 3 0 01-3-3h6a3 3 0 01-3 3z"/>
        </svg>
        <div class="absolute rounded-full bg-red text-white text-xxs w-6 h-6 flex justify-center items-center border-2
        -top-1 -right-1">
            8
        </div>
    </button>
    <ul
        ...
        class="absolute w-76 md:w-96 text-left text-sm bg-white shadow-dialog rounded-xl max-h-128 overflow-y-auto z-10
