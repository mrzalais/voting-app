<div class="comment-container relative bg-white rounded-xl flex transition duration-150 ease-in mt-4">
    <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
        ...
        <div class="w-full md:mx-4">
            {{-- <h4 class="text-xl font-semibold">
                <a href="#"
                   class="hover:underline">A random title can go here</a>
            </h4> --}}
            <div class="text-gray-600 transition duration-150">
                {{ $comment->body }}
            </div>
                    ...
                    <div class="flex items-center space-x-2" x-data="{ isOpen: false}">
                        <div class="relative">
                            ...
                            >
                                ...
                                100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0
