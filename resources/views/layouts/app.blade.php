            ...
            <div class="bg-white md:sticky md:top-8 border-2 border-blue rounded-xl mt-16" style="
                ...
                <div class="text-center px-6 py-2 pt-6">
                    ...
                    <p class="text-xs mt-4">
                        @auth
                            Let us know what you would like and we'll taka a look over!
                        @else
                ...
                @else
                    <div class="my-6 text-center">
                        ...
                        href="{{ route('login') }}"
                        type="submit"
                        class="inline-block justify-center w-1/2
        ...
        <div class="w-full px-2 md:px-0 md:w-175">
            <nav class="hidden md:flex items-center justify-between text-xs">
                <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                    ...
                    <li><a href="#"
                            class="text-gray-400 transition duration-150 ease-in
                             border-b-4 pb-3 hover:border-blue">Considering
                            (6)</a></li>
                    <li><a href="#"
                            class="text-gray-400 transition duration-150 ease-in
                                border-b-4 pb-3 hover:border-blue">In
                            progress (1)</a></li>
                </ul>
                ...
                <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                    <li><a href="#"
                            class="text-gray-400 transition duration-150 ease-in
                             border-b-4 pb-3 hover:border-blue">Implemented
                            (10)</a></li>
                    <li><a href="#"
                            class="text-gray-400 transition duration-150 ease-in
                                border-b-4 pb-3 hover:border-blue">Closed
                            (55)</a></li>
                </ul>
            </nav>
