<x-app-layout>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <svg fill="currentColor" width="24" height="6"><path d="M2.97.061A2.969 
                            2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0 100-5.94zm9.184
                             ...
                             10-.003 5.94A2.97 2.97 0 0021.03.06z" 
                             style="color: rgba(163, 163, 163, .5)">
                        </svg> 
                        <ul class="hidden absolute w-44 text-left font-semibold bg-white 
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            <div class="relative">
                <button type="button" class="flex items-center justify-center h-11 w-32 text-sm 
                ...
                <div class="absolute z-10 w-104 text-left font-semibold text-sm bg-white
                    ...
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                stroke-width="2" d="M15.172 7l-6.586 6.586a2 2 0 102.828 
            ...
            <div class="relative">
                <button type="button" class="flex items-center justify-center w-36
                ...
                shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" checked="" class="bg-gray-200 
                                    text-gray-600 border-none" name="radio-direct" value="1" 
                                    >
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 
                                    text-purple border-none" name="radio-direct" value="2">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 
                                    text-yellow border-none" name="radio-direct" value="3">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 
                                    text-green border-none" name="radio-direct" value="4">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 
                                    text-red border-none" name="radio-direct" value="5">
                        ...
                        <div class="flex items-center justify-between space-x-3">
                            <button type="button" class="flex items-center justify-center w-1/2
                            h-11 text-xs bg-gray-200 font-semibold rounded-xl border
                            border-gray-200 hover:border-gray-400 transition duration-150
                            ease-in px-6 py-3">
                            <svg class="text-gray-600 w-4 transform -rotate-45" fill="none" 
                            ...
                            <button type="submit" class="flex items-center justify-center w-1/2
        ...
        <div class="flex items-center space-x-3">
            ...
            <button type="button" class="w-32
            h-11 text-xs bg-gray-200 font-semibold rounded-xl uppercase border
            border-gray-200 hover:border-gray-400 transition duration-150
            ease-in px-6 py-3">
            <span>Vote</span>
            </button>
                ...
                <div class="w-full mx-4">
                    ...
                    <div class="text-gray-600 mt-3 transition duration-150">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam repudiandae
                         nobis, alias temporibus porro qui expedita ipsum dolore nostrum amet.
                    </div>
                    <div class="flex items-center justify-between mt-6">
                        <div class="flex items-center text-xs text-gray-400 font-semibold 
                        space-x-2">
